        ...
        <form onSubmit={onSubmit()}>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="university" value={university} placeholder="University/College" onChange={(event) => { setUniversity(event.target.value) }} />
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="bankName" value={bankName} placeholder="Bank Name" onChange={(event) => { setBankName(event.target.value) }} />
            </div>
            <div class="form-group col-md-4">
              <label for="bankAccNum">Account Number</label>
              <input type="text" class="form-control" id="bankAccNum" value={bankAccNum} placeholder="Account Number" onChange={(event) => { setBankAccNum(event.target.value) }} />
            </div>
            <div class="form-group col-md-4">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="date" class="form-control" id="bankAddress" value={bankAddress} placeholder="Bank Branch Address" onChange={(event) => { setBankAddress(event.target.value) }} />
            </div>
            <div class="form-group col-md-4">
              <label for="permanantAddress">Permanant Address</label>
              <input type="text" class="form-control" id="permanantAddress" value={permanantAddress} placeholder="Permanant Address" onChange={(event) => { setPermanantAddress(event.target.value) }} />
            </div>
            <div class="form-group col-md-4">
              <label for="presentAddress">Present Address</label>
              <input type="text" class="form-control" id="presentAddress" value={presentAddress} placeholder="Present Address" onChange={(event) => { setPresentAddress(event.target.value) }} />
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-4">
