    ...
    return (
        <div className="login1_container">
            ...
            <div className="btn-group_login1">
                ...
                <Link to ="./login2_Ad" style={{textDecoration: 'none',marginTop: '0px'}}><button type="button" className="btn btn-outline-primary" onClick="onClickStaff()">Admin Login</button></Link>
            </div>
        </div>
    );
}
